...
|---|---|---|---|
| `UI Locale` | Только текст интерфейса плагина (настройки, sidebar, уведомления, диалоги) | `auto` | Следует за языком Obsidian. Текущие UI-каталоги: `en`, `zh-CN`, `zh-TW`. |
...
- Официальная документация поддерживается на английском и упрощённом китайском, при этом заявлена полная поддержка более чем 30 языков.
- Все поддерживаемые языки перечислены в шапке выше.
...
*Notemd v1.8.0 — усиливайте граф знаний Obsidian с помощью ИИ.*
