...
## คำขอบคุณและโครงการอ้างอิง

Notemd ได้รับการดูแลอย่างอิสระ เราขอขอบคุณโครงการและชุมชนโอเพนซอร์สที่มีอิทธิพลต่อการตัดสินใจด้านการออกแบบที่มีเอกสารรองรับ หรือเป็นรากฐานของการผสานรวม การระบุรายชื่อเป็นเพียงการยอมรับอิทธิพลหรือการทำงานร่วมกันเท่านั้น ไม่ได้หมายถึงการรับรอง ความเกี่ยวข้อง โค้ดที่รวมมาด้วย หรือการอ้างว่าใช้โค้ดซ้ำ

- **โครงการอ้างอิง:** [cloudy-tech-diagrams-skill](https://github.com/cloudy-liu/cloudy-tech-diagrams-skill), [Drawnix](https://github.com/plait-board/drawnix), [diagrams.net / draw.io](https://www.diagrams.net/), [repo-saga](https://github.com/teee32/repo-saga).
- **รากฐานโอเพนซอร์ส:** [Mermaid](https://github.com/mermaid-js/mermaid), [Vega-Lite](https://vega.github.io/vega-lite/), [Slidev](https://github.com/slidevjs/slidev), [CircuitikZ](https://github.com/circuitikz/circuitikz), [Tectonic](https://github.com/tectonic-typesetting/tectonic), [Docusaurus](https://docusaurus.io).
- แต่ละโครงการยังคงมีใบอนุญาตและเงื่อนไขของตนเอง; Notemd ใช้งานได้ภายใต้ [ใบอนุญาต MIT](./LICENSE)
...
*Notemd v1.9.7 - ยกระดับกราฟความรู้ใน Obsidian ของคุณด้วย AI*
...
_รีเฟรชล่าสุดสำหรับแท็กรุ่น `1.9.7` เมื่อ 2026-08-31 วันที่คอมมิตล่าสุด: 2026-08-31_
<!-- repo-chronicle:end -->
...
หน้าการตั้งค่า Notemd มีฟีเจอร์ค้นหาแบบคลุมเครือที่สามารถรู้จักประเภทข้อมูลได้, การนำทางตามหมวดหมู่ขนาดใหญ่, แถบเครื่องมือสำหรับค้นหาที่สามารถพับเก็บได้, รวมถึงการบันทึกรายการโปรดตามแต่ละการตั้งค่าสำหรับ Vault ปัจจุบัน ให้คลิกที่ **★ Favorites** เพื่อเปิดรายการที่กำหนดไว้โดยเฉพาะ โดยแต่ละรายการจะนำไปยังหน้าการตั้งค่าที่เกี่ยวข้องโดยตรง และสามารถลบออกได้โดยไม่ต้องออกจากหน้าการตั้งค่า

- ประวัติแผนภาพจะถูกเก็บไว้ในขอบเขต Vault โดยเรียงลำดับจากใหม่ที่สุดไปเก่าที่สุด สามารถค้นหาและแสดงผลเป็นกลุ่มละ 20 รายการ การลบบันทึกประวัติจะไม่ส่งผลให้ไฟล์ที่ถูกสร้างขึ้นหายไป
- การส่งออกตัวอย่างแผนภาพด้วย PPI จะมีค่าเริ่มต้นที่ 300 และรองรับค่าระหว่าง 72–600 ฟีเจอร์นี้ควบคุมการแปลงรูปแบบเป็นราสเตอร์ของ PNG เท่านั้น ส่วน SVG และ PDF จะยังคงเป็นรูปแบบเวกเตอร์ต่อไป
- นอกจากนี้ การส่งออกภาพทั้งหมดของ Mermaid ยังสามารถเลือกเขียนแหล่งโค้ดของ Mermaid, SVG และไฟล์ manifest ที่เกี่ยวข้องได้อีกด้วย แม้จะปิดใช้งาน Mermaid ไปแล้ว ก็ยังสามารถดูตัวอย่างผลลัพธ์ใน Drawnix ได้อยู่
- ประเภทแผนภาพที่ต้องการและรูปแบบแหล่งโค้ดที่ต้องการเป็นตัวเลือกที่แยกจากกัน
- ผู้ใช้งานบนเดสก์ท็อปสามารถเปิดสภาพแวดล้อมคอมไพล์แบบดั้งเดิมของ CircuitikZ ซึ่งเป็นตัวเลือกเสริม เพื่อใช้ Tectonic/pdflatex ของระบบซ้ำ, เลือกคอมไพเลอร์ที่กำหนดเอง หรือติดตั้ง Tectonic runtime ที่ถูกกำหนดให้ใช้งานโดยตรง การดูตัวอย่าง, SVG, PNG และการส่งออกตัวอย่างของ PDF ไม่จำเป็นต้องใช้ LaTeX
- ฟีเจอร์การเลือกไฟล์แบบกลุ่มขั้นสูงช่วยให้สามารถใช้โปรไฟล์การเลือกที่บันทึกไว้และดูตัวอย่างกฎต่าง ๆ ได้
- หากไม่มีโฟลเดอร์ปลายทางสำหรับจัดการไฟล์แบบกลุ่ม สามารถสร้างขึ้นมาได้หลังจากยืนยัน พร้อมตัวเลือกในการจดจำการสร้างโฟลเดอร์แบบนี้โดยอัตโนมัติสำหรับโฟลเดอร์ที่ขาดหายไปในอนาคต
- หากเป็นโฟลเดอร์ที่มีเนื้อหาอยู่แล้ว จะต้องมีการยืนยันหนึ่งครั้งสำหรับการจัดการไฟล์แบบกลุ่มทั้งหมด ไม่ใช่การยืนยันหนึ่งครั้งต่อไฟล์ที่ถูกสร้างขึ้นแต่ละไฟล์
- โหมดนักพัฒนาจะแสดงข้อมูลวินิจฉัยจากผู้ให้บริการและควบคุมสำหรับการแก้ไขปัญหาขั้นสูง
