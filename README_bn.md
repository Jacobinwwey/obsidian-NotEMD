...
## কৃতজ্ঞতা ও রেফারেন্স প্রকল্প

Notemd স্বাধীনভাবে রক্ষণাবেক্ষণ করা হয়। নথিভুক্ত নকশা সিদ্ধান্তে প্রভাব ফেলেছে বা ইন্টিগ্রেশনের ভিত্তি দিয়েছে এমন মুক্ত-উৎস প্রকল্প ও কমিউনিটিকে আমরা ধন্যবাদ জানাই। এখানে তালিকাভুক্তি কেবল প্রভাব বা আন্তঃপরিচালনযোগ্যতা স্বীকার করে; এটি অনুমোদন, সংশ্লিষ্টতা, বান্ডেল করা কোড বা কোড পুনঃব্যবহারের দাবি নয়।

- **রেফারেন্স প্রকল্প:** [cloudy-tech-diagrams-skill](https://github.com/cloudy-liu/cloudy-tech-diagrams-skill), [Drawnix](https://github.com/plait-board/drawnix), [diagrams.net / draw.io](https://www.diagrams.net/), [repo-saga](https://github.com/teee32/repo-saga).
- **মুক্ত-উৎস ভিত্তি:** [Mermaid](https://github.com/mermaid-js/mermaid), [Vega-Lite](https://vega.github.io/vega-lite/), [Slidev](https://github.com/slidevjs/slidev), [CircuitikZ](https://github.com/circuitikz/circuitikz), [Tectonic](https://github.com/tectonic-typesetting/tectonic), [Docusaurus](https://docusaurus.io).
- প্রতিটি প্রকল্প তার নিজস্ব লাইসেন্স ও শর্ত বজায় রাখে; Notemd [MIT লাইসেন্সে](./LICENSE) উপলব্ধ।
...
*Notemd v1.9.6 - AI-এর সাহায্যে আপনার Obsidian knowledge graph আরও উন্নত করুন।*


<!-- repo-chronicle:start -->
## উন্নয়ন ক্রনিকল

এই ত্রৈমাসিক ক্রনিকলটি [repo-saga](https://github.com/teee32/repo-saga)-এর মূল ভিজ্যুয়াল স্টাইল বজায় রাখে; শুধু যুগভাগকে বছর থেকে ত্রৈমাসিকে বদলানো হয়েছে।

![Notemd Development Chronicle](./docs/repo-saga/notemd-development-history.bn.svg)

_সর্বশেষ `1.9.6` রিলিজ ট্যাগের জন্য 2026-08-09 তারিখে রিফ্রেশ করা হয়েছে। সর্বশেষ কমিটের তারিখ: 2026-08-09।_
<!-- repo-chronicle:end -->
...
Notemd সেটিংস পৃষ্ঠাটি ফিল্ড-সচেতন ফাজি সার্চ, বৃহৎ ক্যাটাগরি নেভিগেশন, একটি কল্যাপসিবল ডিসকভারি টুলবার, এবং বর্তমান Vault-এর জন্য সংরক্ষিত প্রতিটি সেটিংসের ফেভারিটস প্রদান করে। **★ Favorites**-এ ক্লিক করলে একটি বিশেষ তালিকা খুলবে; প্রতিটি এন্ট্রি সরাসরি সংশ্লিষ্ট সেটিংসে নিয়ে যাবে এবং সেটিংস পৃষ্ঠা ছেড়ে না গিয়েই সেগুলো মুছে ফেলা যাবে।

- ডায়াগ্রামের ইতিহাস Vault স্কোপে সংরক্ষিত থাকে, সর্বনবীনতম থেকে শুরু করে; ২০টি করে গ্রুপে অনুসন্ধান ও পেজিং করা যায়। ইতিহাসের কোনো রেকর্ড মুছলেও তৈরি হওয়া ফাইলগুলো মুছে যায় না।
- ডায়াগ্রাম প্রিভিউ এক্সপোর্টের জন্য PPI-এর ডিফল্ট মান 300, এবং এটি 72-600 মান গ্রহণ করে। এটি শুধুমাত্র PNG রাস্টারাইজেশনকে নিয়ন্ত্রণ করে; SVG ও PDF ভেক্টর-ভিত্তিকই থাকে।
- ঐচ্ছিকভাবে সম্পূর্ণ Mermaid ভিজ্যুয়ালগুলো এক্সপোর্ট করলে Mermaid সোর্স, SVG, এবং ম্যানিফেস্ট ফাইলগুলোও সংরক্ষিত হয়; Mermaid নিষ্ক্রিয় থাকলেও Drawnix প্রিভিউগুলোতে এটি উপলব্ধ থাকে।
- পছন্দের ডায়াগ্রাম টাইপ ও পছন্দের সোর্স ফরম্যাট হলো আলাদা দুটি বিকল্প।
- ডেস্কটপ ব্যবহারকারীরা ঐচ্ছিকভাবে CircuitikZ নেটিভ কম্পাইল এনভায়রনমেন্ট খুলে সিস্টেমের Tectonic/pdflatex ব্যবহার করতে পারেন, নিজস্ব কম্পাইলার নির্বাচন করতে পারেন, অথবা নির্দিষ্ট Tectonic রানটাইম ইনস্টল করতে পারেন। প্রিভিউ, SVG, PNG, এবং PDF এর প্রিভিউ এক্সপোর্টের জন্য LaTeX-এর প্রয়োজন হয় না।
- অ্যাডভান্সড ব্যাচ ফাইল সিলেকশনের মাধ্যমে সংরক্ষিত সিলেকশন প্রোফাইল ও নিয়মগুলোর প্রিভিউ দেখা যায়।
- কোনো ব্যাচ টার্গেট ফোল্ডার না থাকলে নিশ্চিত হওয়ার পর সেটি তৈরি করা যায়, এবং ভবিষ্যতে আরও ফোল্ডার না থাকলে স্বয়ংক্রিয়ভাবে এটি তৈরি করার অপশনও রয়েছে।
- ইতিমধ্যে থাকা কোনো খালি নয় এমন ফোল্ডারের জন্য পুরো ব্যাচটি এক্সেকিউট করার আগে একবার নিশ্চিত হতে হয়; প্রতিটি ফাইলের জন্য আলাদাভাবে নিশ্চিত হওয়ার দরকার নেই।
- ডেভেলপার মোডে প্রোভাইডার সংক্রান্ত ডায়াগনস্টিক্স ও অ্যাডভান্সড ট্রাবলশুটিং কন্ট্রোলসমূহ দেখা যায়।
