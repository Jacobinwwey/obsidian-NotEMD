...
const RELEASE_WORKFLOW_TAG_TRIGGER_GLOB = '*.*.*';

const RELEASE_WORKFLOW_DISALLOWED_TAG_TRIGGER_GLOBS = [
    'v*.*.*',
    'V*.*.*'
];

const RELEASE_WORKFLOW_SOURCE_BRANCH = 'main';

const RELEASE_CHRONICLE_REFRESH_TARGET_BRANCH = 'main';
