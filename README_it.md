...
|---|---|---|---|
| `UI Locale` | Solo testo dell'interfaccia del plugin (impostazioni, barra laterale, avvisi, dialoghi) | `auto` | Segue la lingua di Obsidian; i cataloghi attuali sono `en`, `zh-CN`, `zh-TW`. |
