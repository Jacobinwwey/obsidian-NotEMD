...
## आभार और संदर्भ परियोजनाएँ

Notemd का रखरखाव स्वतंत्र रूप से किया जाता है। हम उन ओपन-सोर्स परियोजनाओं और समुदायों के आभारी हैं जिन्होंने प्रलेखित डिज़ाइन निर्णयों को प्रभावित किया या एकीकरण की नींव प्रदान की। यहाँ सूचीबद्ध होना केवल प्रभाव या अंतःक्रियाशीलता को स्वीकार करता है; इसका अर्थ समर्थन, संबद्धता, बंडल किए गए कोड या कोड पुन: उपयोग का दावा नहीं है।

- **संदर्भ परियोजनाएँ:** [cloudy-tech-diagrams-skill](https://github.com/cloudy-liu/cloudy-tech-diagrams-skill), [Drawnix](https://github.com/plait-board/drawnix), [diagrams.net / draw.io](https://www.diagrams.net/), [repo-saga](https://github.com/teee32/repo-saga).
- **ओपन-सोर्स आधार:** [Mermaid](https://github.com/mermaid-js/mermaid), [Vega-Lite](https://vega.github.io/vega-lite/), [Slidev](https://github.com/slidevjs/slidev), [CircuitikZ](https://github.com/circuitikz/circuitikz), [Tectonic](https://github.com/tectonic-typesetting/tectonic), [Docusaurus](https://docusaurus.io).
- हर परियोजना अपना लाइसेंस और शर्तें रखती है; Notemd [MIT लाइसेंस](./LICENSE) के अंतर्गत उपलब्ध है।
...
*Notemd v1.9.6 - AI के साथ अपने Obsidian knowledge graph को बेहतर बनाएँ।*
...
_इसे रिलीज़ टैग `1.9.6` के लिए 2026-08-09 को अंतिम बार रीफ़्रेश किया गया। नवीनतम कमिट तिथि: 2026-08-09।_
<!-- repo-chronicle:end -->
...
## सेटिंग्स की खोज, डायग्राम हिस्ट्री, CircuitikZ, एवं सुरक्षित बैच फोल्डर

Notemd सेटिंग्स पृष्ठ, फील्ड-संबंधी फजी सर्च, बड़ी श्रेणियों का नेविगेशन, एक “कॉलैप्सिबल” डिस्कवरी टूलबार, तथा वर्तमान Vault के लिए संग्रहीत पसंदीदा सेटिंग्स प्रदान करता है। एक विशेष सूची खोलने हेतु **★ Favorites** पर क्लिक करें; प्रत्येक प्रविष्टि सीधे उसकी संबंधित सेटिंग पर जाती है, एवं सेटिंग्स पृष्ठ छोड़े बिना ही उसे हटाया जा सकता है।

- डायग्राम हिस्ट्री Vault स्कोप में संग्रहीत होती है, नवीनतम से पुराने क्रम में, एवं 20 के समूहों में खोज एवं पेजित की जा सकती है। हिस्ट्री रिकॉर्ड हटाने से बनाए गए फ़ाइलें नष्ट नहीं होतीं।
- डायग्राम प्रीव्यू का निर्यात PPI द्वारा 300 के मान पर डिफ़ॉल्ट रूप से किया जाता है, एवं 72-600 के मान स्वीकार किए जाते हैं। यह केवल PNG की रास्टराइज़ेशन प्रक्रिया को ही नियंत्रित करता है; SVG एवं PDF वेक्टर-आधारित ही रहते हैं।
- वैकल्पिक रूप से, पूरे Mermaid विज़ुअल्स का निर्यात करने पर Mermaid स्रोत, SVG, एवं मैनिफेस्ट फ़ाइलें भी लिखी जाती हैं; Mermaid को डिसेबल करने पर भी Drawnix प्रीव्यू में यह उपलब्ध रहता है।
- पसंदीदा डायग्राम प्रकार एवं पसंदीदा स्रोत फॉर्मेट अलग-अलग विकल्प हैं।
- डेस्कटॉप उपयोगकर्ता, सिस्टम के Tectonic/pdflatex का पुनः उपयोग करने हेतु, कस्टम कंपाइलर चुनने हेतु, या पिन की गई मैनेज्ड Tectonic रनटाइम को स्पष्ट रूप से इंस्टॉल करने हेतु, वैकल्पिक CircuitikZ नेटिव कंपाइल वातावरण खोल सकते हैं। प्रीव्यू, SVG, PNG, एवं PDF का निर्यात LaTeX की आवश्यकता नहीं रखता।
- उन्नत बैच फ़ाइल चयन सुविधा, संग्रहीत चयन प्रोफ़ाइल्स एवं नियमों के प्रीव्यू की सुविधा देती है।
- यदि कोई बैच लक्ष्य फोल्डर अनुपस्थित हो, तो पुष्टि के बाद उसे बनाया जा सकता है, एवं भविष्य में ऐसे अनुपस्थित फोल्डरों को स्वचालित रूप से बनाने का विकल्प भी उपलब्ध है।
- यदि कोई मौजूदा, गैर-खाली फोल्डर हो, तो पूरे बैच को संसाधित करने से पहले केवल एक ही पुष्टि आवश्यक होती है; प्रत्येक बनाई गई फ़ाइल के लिए अलग-अलग पुष्टि की आवश्यकता नहीं होती।
- डेवलपर मोड, प्रदाता संबंधी डायग्नोस्टिक्स एवं उन्नत ट्रबलशूटिंग नियंत्रण दर्शाता है।
