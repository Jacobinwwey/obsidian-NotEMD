...
- **Sidebar Deep Debug + API Liveness**: The footer log area now exposes a quick `Deep debug` checkbox that turns on verbose raw-response logging without leaving the sidebar, and the ready/progress card now includes an API liveness indicator that distinguishes waiting for output, normal output reception, long-running healthy tasks, successful response receipt, and interrupted output.
...
*Notemd v1.8.7 - Enhance your Obsidian knowledge graph with AI.*
...
_Last refreshed for release tag `1.8.7` on 2026-05-12. Latest commit date: 2026-05-12._
<!-- repo-chronicle:end -->
