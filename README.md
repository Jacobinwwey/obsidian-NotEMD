...
| Drawnix | `_diagram.drawnix` with inline Mermaid source visuals; SVG/media companions only for the primary preview or unresolved/non-inline media | SVG companion | Yes | Yes | Yes | Yes | Single document root by default, obstacle-aware cross-root arrows, self-contained Mermaid previews, and no Drawnix or Plait runtime bundled. |
...
*Notemd v1.9.4 - Enhance your Obsidian knowledge graph with AI.*
...
_Last refreshed for release tag `1.9.4` on 2026-07-21. Latest commit date: 2026-07-21._
<!-- repo-chronicle:end -->
