...
export const SIDEBAR_ACTION_DEFINITIONS = [
    ...
    { id: 'batch-extract-original-text', label: 'Batch extract specific original text', translationKey: 'batchExtractOriginalText', category: 'knowledge', automationLevel: 'interactive-ui', requiredContext: 'folder-selection', sideEffectClass: 'batch-write' },
    { id: 'split-note-by-chapters', label: 'Split note by chapters', translationKey: 'splitNoteByChapters', category: 'knowledge', automationLevel: 'requires-active-file', requiredContext: 'active-file', sideEffectClass: 'write-file' },
