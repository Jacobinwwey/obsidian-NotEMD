...
describe('supported UI locale provider config coverage', () => {
    test('ships localized provider configuration copy for all advertised locales', () => {
        ...
        const providerFields = [
            ...
            { label: 'settings.providerConfig.modelKnownMaxOutputTokensHint', get: (strings: typeof en) => strings.settings.providerConfig.modelKnownMaxOutputTokensHint },
            ...
            { label: 'settings.providerConfig.discoveredModelTokenSyncName', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelTokenSyncName },
            { label: 'settings.providerConfig.discoveredModelTokenSyncDesc', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelTokenSyncDesc },
            ...
            { label: 'settings.providerConfig.discoveredModelsSummary', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsSummary },
            { label: 'settings.providerConfig.discoveredModelsSummaryWithCurrent', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsSummaryWithCurrent },
            ...
            { label: 'settings.providerConfig.discoveredModelsUsingButton', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsUsingButton },
            { label: 'settings.providerConfig.discoveredModelsApplied', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsApplied },
            { label: 'settings.providerConfig.discoveredModelsAppliedAutoMaxOutputTokens', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsAppliedAutoMaxOutputTokens },
            { label: 'settings.providerConfig.discoveredModelsAppliedManualMaxOutputTokensNeeded', get: (strings: typeof en) => strings.settings.providerConfig.discoveredModelsAppliedManualMaxOutputTokensNeeded },
            ...
            { label: 'settings.providerConfig.maxOutputTokensKnownModelHint', get: (strings: typeof en) => strings.settings.providerConfig.maxOutputTokensKnownModelHint },
