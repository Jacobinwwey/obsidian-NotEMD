export const STRINGS_EN = {
    ...
    previewModal: {
        ...
        exportFolderTitle: 'Export each diagram as separate SVG files',
        exportFolderDescription: 'Choose a Vault folder. Each preview panel will be written as its own SVG file.',
        ...
        exportFolderConfirm: 'Export SVG files',
        ...
        exportFolderBatchSuccessNotice: 'Exported {success} of {total} SVG files to {path}',
        exportFolderBatchPartialNotice: 'Exported {success} of {total} SVG files. Failed: {failures}.',
