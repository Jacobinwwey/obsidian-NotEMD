export const STRINGS_EN = {
    ...
    settings: {
        ...
        localKnowledge: {
            ...
            enableDesc: 'On: Build a lightweight local index from configured knowledge-base folders and append retrieved context only for the enabled tasks below.',
            pathsName: 'Knowledge base folder paths',
            pathsDesc: 'Enter one vault-relative folder path per line. Only Markdown and text files under these paths are indexed.',
