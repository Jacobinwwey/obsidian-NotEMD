export const STRINGS_EN = {
    ...
    folderPicker: {
        ...
        selectionProfileDesc: 'Choose a folder plus an optional saved file-selection profile for this run.',
    ...
    settings: {
        ...
        folderTaskFilter: {
            ...
            profilesDesc: 'Reusable named profiles for folder tasks. A profile can also store an optional preferred folder path for picker prefill, while still allowing run-time changes.',
            ...
            profileFolderPathDesc: 'Optional saved folder path used as the initial picker value. You can still change the folder at run time.',
