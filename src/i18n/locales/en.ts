export const STRINGS_EN = {
    ...
    settings: {
        ...
        developer: {
            ...
            experimentalDiagramPipeline: {
                ...
                intentBarChart: 'Bar chart (Vega-Lite)',
                intentLineChart: 'Line chart (Vega-Lite)',
                intentScatterPlot: 'Scatter plot (Vega-Lite)',
                ...
                intentCurrentState: 'IT current state',
                intentIntegrationTopology: 'Integration topology',
                intentDataFlow: 'Data flow',
                intentAccessMatrix: 'Access matrix',
                intentGantt: 'Gantt schedule',
                intentLayerStack: 'Layer stack',
                intentSetOverlap: 'Venn overlap',
                intentRankedFunnel: 'Pyramid / funnel',
                intentLoop: 'Operating loop',
                intentNested: 'Nested scope',
                intentTree: 'Tree hierarchy',
                intentProcess: 'Process flow',
                intentMedallion: 'Medallion tiers',
                intentHighLevel: 'High-level overview',
                renderTargetName: 'Preferred source format',
                renderTargetDesc: 'Choose the editable or reusable source format created by Generate diagram. Auto selects a compatible format for the diagram type.',
                renderTargetAuto: 'Auto',
                ...
                renderTargetDrawio: 'Draw.io source file',
                renderTargetDrawnix: 'Drawnix source file',
                renderTargetCircuitikz: 'CircuitikZ source file',
                previewExportHeading: 'Diagram preview & export',
                ...
                diagramExampleGalleryName: 'Diagram examples',
                diagramExampleGalleryDesc: 'Preview renderer-backed examples for each diagram type before generating from a note.',
                diagramExamplePreview: 'Preview example',
                diagramExampleUseType: 'Use this diagram type',
                diagramExampleThumbnailLoading: 'Rendering preview',
                diagramExampleThumbnailUnavailable: 'Preview unavailable',
                diagramTypePreviewTitle: 'Selected type preview',
                diagramTypePreviewEmpty: 'Select a diagram type to render its preview.',
                ...
                diagramExampleFamilyQuantitative: 'Quantitative',
                diagramExampleFamilyEngineering: 'Engineering',
                diagramCapabilityTargetPrefix: 'Target',
                diagramCapabilityFormatsPrefix: 'Exports',
                circuitikzHeading: 'CircuitikZ native environment',
    ...
    previewModal: {
        ...
        exportPdfSuccessNotice: 'Diagram PDF exported to {path}',
        exportPdfFailedNotice: 'Failed to export diagram PDF: {message}',
        exportFolderTitle: 'Export each diagram as separate {format} files',
        exportFolderDescription: 'Choose a Vault folder. Each preview panel will be written as its own {format} file.',
        exportFolderDefaultOption: 'Source folder ({path})',
        exportFolderCustomOption: 'Custom Vault folder',
        exportFolderCustomPlaceholder: 'e.g. Exports/Architecture',
        exportFolderConfirm: 'Export {format} files',
        exportFolderCancel: 'Cancel',
        exportFolderInvalid: 'Enter a valid Vault-relative folder path.',
        exportFolderCreateFailed: 'Unable to prepare export folder: {message}',
        exportFolderBatchSuccessNotice: 'Exported {success} of {total} {format} files to {path}',
        exportFolderBatchPartialNotice: 'Exported {success} of {total} {format} files. Failed: {failures}.',
    ...
    slideExport: {
        ...
        defaultFormatDesc: 'PPTX/PDF/PNG require Playwright; MP4 also requires ffmpeg.',
        ...
        pptxLatinFontName: 'PPTX Latin font',
        pptxLatinFontDesc: 'Office font face for Latin text runs. Custom names must exist on the target system; fonts are not embedded by default.',
        pptxEastAsiaFontName: 'PPTX East Asian font',
        pptxEastAsiaFontDesc: 'Office font face for CJK and full-width text runs. Custom names must exist on the target system; fonts are not embedded by default.',
        pptxMonospaceFontName: 'PPTX monospace font',
        pptxMonospaceFontDesc: 'Office font face for code and monospace text runs. Custom names must exist on the target system; fonts are not embedded by default.',
        pptxCustomSystemFontOption: 'Custom/system font',
        ...
        imageClarityName: 'Image clarity (PNG / MP4)',
        imageClarityDesc: 'Render scale for raster image exports. Higher = sharper Mermaid diagrams. Standard ~144 ppi, High ~288 ppi, Ultra ~432 ppi.',
        imageClarityStandard: 'Standard (~144 ppi)',
        imageClarityHigh: 'High (~288 ppi)',
        imageClarityUltra: 'Ultra (~432 ppi, default)',
