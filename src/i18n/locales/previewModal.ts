...
export const PREVIEW_MODAL_LOCALE_EXTENSIONS: Record<string, DeepPartial<NotemdEnglishStrings>> = {
    ...
    zh: {
        previewModal: {
            ...
            exportPdfSuccessNotice: '图形 PDF 已导出到 {path}',
            exportPdfFailedNotice: '导出图形 PDF 失败：{message}',
    ...
    'zh-TW': {
        previewModal: {
            ...
            exportPdfSuccessNotice: '圖形 PDF 已匯出到 {path}',
            exportPdfFailedNotice: '匯出圖形 PDF 失敗：{message}',
