...
|---|---|---|---|
| `UI Locale` | نص واجهة الإضافة فقط (الإعدادات، الشريط الجانبي، الإشعارات، الحوارات) | `auto` | يتبع لغة Obsidian الحالية؛ كتالوجات الواجهة الحالية هي `en` و `zh-CN` و `zh-TW`. |
...
- تتم صيانة الوثائق الرسمية بالإنجليزية والصينية المبسطة، مع دعم كامل لأكثر من 30 لغة.
...
*Notemd v1.8.0 - عزّز الرسم المعرفي في Obsidian باستخدام الذكاء الاصطناعي.*
