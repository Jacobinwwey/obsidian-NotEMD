...
*Notemd v1.9.6 - عزّز الرسم المعرفي في Obsidian باستخدام الذكاء الاصطناعي.*
...
_تم آخر تحديث للإصدار ذي الوسم `1.9.6` في 2026-08-09. تاريخ أحدث التزام: 2026-08-09._
<!-- repo-chronicle:end -->
...
## اكتشاف الإعدادات، تاريخ الرسوم التخطيطية، CircuitikZ، ومجلدات المجموعات الآمنة

توفر صفحة إعدادات Notemd بحثًا غامضًا يأخذ في الاعتبار خصائص الحقول، وتنقلًا سهلاً بين الفئات الكبيرة، وشريط أدوات اكتشاف قابل للطي، بالإضافة إلى قائمة المفضلات الخاصة بكل إعداد محفوظة لـ Vault الحالي. انقر على **★ Favorites** لفتح قائمة مخصصة؛ كل عنصر فيها ينتقل مباشرة إلى إعداده ويمكن حذفه دون مغادرة صفحة الإعدادات.

- يتم تخزين تاريخ الرسوم التخطيطية في نطاق Vault، مرتبًا من الأحدث إلى الأقدم، ويمكن البحث فيه وعرضه عبر صفحات بحجم 20 عنصرًا في كل صفحة. حذف سجل من التاريخ لا يؤدي إلى حذف الملفات المولدة.
- تكون قيمة الصادرة عن ميزة عرض مسبق للرسوم التخطيطية في PPI افتراضيًا 300، ويمكن تعديلها بين 72 و600. تؤثر هذه القيمة فقط على عملية تحويل الرسوم إلى صيغة رستر في PNG؛ بينما تظل SVG وPDF قائمتين على أساس الصيغة النقطية.
- كما يمكن تصدير الرسوم التخطيطية الكاملة في Mermaid، وبشكل اختياري يتم أيضًا كتابة مصدر Mermaid وSVG بالإضافة إلى الملفات المرافقة؛ وحتى عند تعطيله، يظل Mermaid متاحًا في عروض المسبقة في Drawnix.
- نوع الرسم التخطيطي المفضل وصيغة المصدر المفضلة هما خياران منفصلان.
- يمكن لمستخدمي سطح المكتب فتح بيئة التجميع الأصلية CircuitikZ الاختيارية لإعادة استخدام أدوات Tectonic/pdflatex الموجودة في النظام، أو اختيار مُجمّع مخصص، أو تثبيت برنامج Tectonic الإداري المحدد. لا تتطلب عروض المسبقة وتصديرات SVG وPNG وPDF استخدام لغة LaTeX.
- يتيح خيار اختيار ملفات المجموعات المتقدمة استخدام ملفات تعريف الاختيارات المحفوظة وعروض تجريبية للقواعد.
- يمكن إنشاء مجلد الهدف للمجموعات في حال غيابه بعد التأكيد، مع خيار تذكّر عملية الإنشاء التلقائي للمجلدات المفقودة في المستقبل.
- يتطلب وجود مجلد غير فارغ وجود تأكيد واحد فقط قبل معالجة المجموعة بأكملها، وليس تأكيدًا لكل ملف يتم إنشاؤه على حدة.
- يكشف وضع المطور عن أدوات التشخيص الخاصة بالمزود وأدوات متقدمة لحل المشكلات.
