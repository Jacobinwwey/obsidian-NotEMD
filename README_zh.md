...
- **侧边栏深度调试 + API 测活**: 底部日志区域现在提供快捷 `深度调试` 勾选框，无需离开侧边栏即可开启详细原始响应日志；同时 Ready/进度卡片新增 API 测活状态点，用于区分“等待输出”“正常接收中”“长任务但健康”“已收到响应”与“输出中断”等状态。
...
*Notemd v1.8.8 - 用AI提升你的Obsidian知识图谱。*
...
_最近一次已针对发布 tag `1.8.8` 于 2026-05-12 刷新。 最新提交日期：2026-05-12。_
<!-- repo-chronicle:end -->
