...
<TLDR>
**Start using Notemd in 5 minutes.** Three steps: (1) Add an LLM API key (or use local Ollama), (2) Open a note and run "Process file (add links)", (3) Explore one-click workflows in the sidebar. Supports 36 provider definitions. No coding required. Works offline with Ollama.
</TLDR>
