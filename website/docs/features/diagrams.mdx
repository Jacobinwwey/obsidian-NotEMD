...
id: diagrams
title: Diagrams
description: Generate Mermaid, JSON Canvas, Vega-Lite, HTML, and editable figure artifacts from your notes using a spec-first architecture
author:
  '@id': 'https://jacobinwwey.github.io/obsidian-NotEMD/#person-jacobinwwey'
keywords: [diagrams, mermaid, vega-lite, canvas, visualization, spec-first, drawio, drawnix, editable svg]
concepts: [DiagramSpec, Mermaid, Vega-Lite, JSON Canvas, Editable HTML SVG, Draw.io, Drawnix, Intent Detection, Spec-First Architecture]
citations:
  - title: Mermaid
