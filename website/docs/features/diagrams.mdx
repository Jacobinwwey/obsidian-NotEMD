...
| circuitikz | `CircuitSpec -> circuitikz` prototype exports common-source and CMOS inverter golden templates, and parses existing compile logs into diagnostics through `npm run diagram:export-circuitikz` | Add optional renderer execution, screenshot feedback, and topology-preserving repair |
