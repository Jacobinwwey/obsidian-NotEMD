...
## Objevování nastavení a uložení oblíbených položek Notemd

Stránka s nastaveními je navržena pro opakované použití spíše než pro jednorázovou konfiguraci:

- Použijte vstup **Vyhledávání nastavení** schopný rozpoznávat pole, abyste našli dané nastavení podle jeho názvu, popisu, aliasu nebo viditelné kategorie. Výsledky jsou seřazeny podle důležitosti a umožňují okamžité přejít na konkrétní nastavení.
- Použijte **★ Favorites**, abyste často upravovaná nastavení udrželi v aktuálním Vault. Kliknutím na něj se otevře speciální seznam s názvem nastavení, popisem, kategorií a přímým cílem pro navigaci. Oblíbenou položku můžete ze seznamu odstranit bez opuštění stránky s nastaveními.
- Nástrojová lišta určená k objevování je výchozím způsobem rozbalená. Pokud potřebujete více vertikálního prostoru, použijte tlačítko ve tvaru šipky k jejímu skrytí do plovoucího ovládání v pravém horním rohu; aktuální dotaz zůstane zachován a bude obnoven po opětovném rozbalení.
- Seznam oblíbených položek je nezávislý na filtru určeném výhradně k zobrazení oblíbených položek. Oblíbená nastavení využívají stabilní ID a přežijí restarty Obsidian, přičemž staré ID jsou bezpečně odstraněny, jakmile dané nastavení již neexistuje.

Nastavení **Vývoz náhledu diagramu PPI** má výchozí hodnotu **300 PPI** a přijímá hodnoty od **72 do 600**. Ovlivňuje pouze rasterizaci PNG; SVG a PDF zachovávají vektorovou geometrii. Nastavení **Vývoz také kompletních vizuálů Mermaid** řídí volitelné externí doplňky Mermaid a neovlivňuje viditelnost Mermaid v náhledech Drawnix.
---
