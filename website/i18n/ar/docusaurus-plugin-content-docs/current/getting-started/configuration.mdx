...
## اكتشاف الإعدادات وحفظها كمفضلة في Notemd

تم تصميم صفحة الإعدادات للاستخدام المتكرر بدلاً من التكوين مرة واحدة فقط:

- استخدم مربع البحث **Search settings** الذي يأخذ نوع الحقل في الاعتبار للعثور على إعداد معين من خلال اسمه أو وصفه أو اسمه المستعار أو الفئة المرئية. يتم ترتيب النتائج حسب درجة الأهمية ويمكن الانتقال مباشرة إلى الإعداد المطلوب.
- استخدم **★ Favorites** لحفظ الإعدادات التي يتم تعديلها بشكل متكرر في Vault الحالية. عند النقر عليه، يتم فتح قائمة خاصة تحتوي على اسم الإعداد ووصفه وفئته بالإضافة إلى رابط للانتقال المباشر إليه. يمكن حذف عنصر مفضل من القائمة دون مغادرة صفحة الإعدادات.
- تكون شريط أدوات الاكتشاف مفتوحًا بشكل افتراضي. استخدم زر السهم لطيه وتحويله إلى عنصر تحكم يظهر في الزاوية العلوية اليمنى عند الحاجة إلى مساحة أفقية أكبر؛ حيث يتم الحفاظ على استعلام البحث الحالي وإعادته عند فتح شريط الأدوات مجددًا.
- تعتبر قائمة المفضلات منفصلة عن مرشح "المفضلات فقط". تستخدم المفضلات أرقام تعريف ثابتة للإعدادات، وتظل موجودة حتى بعد إعادة تشغيل Obsidian، كما يتم التخلص من الأرقام التعريفية القديمة بشكل آمن عندما لا يعود الإعداد موجودًا.

يكون إعداد **Diagram preview export PPI** مضبوطًا افتراضيًا على **300 PPI** ويقبل القيم من **72 إلى 600**. يتحكم هذا الإعداد فقط في عملية تحويل الرسومات إلى نمط رقمي في PNG؛ بينما يحافظ كل من SVG وPDF على الهندسة المتجهية للرسومات. أما إعداد **Also export complete Mermaid visuals** فيتحكم في تصدير ملفات Mermaid الخارجية الإضافية اختياريًا، ولا يؤثر على ظهور هذه الملفات في عروض التقديم في Drawnix.
---
