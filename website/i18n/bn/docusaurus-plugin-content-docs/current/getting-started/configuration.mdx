...
## Notemd সেটিংস আবিষ্কার এবং পছন্দের তালিকা

সেটিংস পৃষ্ঠাটি একবারের কনফিগারেশনের জন্য নয়, বরং বারবার ব্যবহারের জন্য ডিজাইন করা হয়েছে:

- কোনো সেটিংসের নাম, বিবরণ, অ্যালিয়াস বা দৃশ্যমান ক্যাটাগরি অনুযায়ী তা খুঁজে পেতে field-aware **Search settings** ইনপুটটি ব্যবহার করুন। ফলাফলগুলি signal-এর ভিত্তিতে সাজানো থাকে এবং আপনি সরাসরি সংশ্লিষ্ট সেটিংসে চলে যেতে পারেন।
- ঘন ঘন সামঞ্জস্য করা সেটিংসগুলি বর্তমান Vault-এ ধরে রাখতে **★ Favorites** ব্যবহার করুন। এটিতে ক্লিক করলে সেটিংসের নাম, বিবরণ, ক্যাটাগরি এবং সরাসরি নেভিগেশন লক্ষ্যস্থলসহ একটি আলাদা তালিকা খুলবে। সেটিংস পৃষ্ঠা ছেড়ে না গিয়েই তালিকা থেকে কোনো পছন্দের আইটেম অপসারণ করুন।
- ডিফল্টভাবে discovery toolbar-টি সক্রিয় থাকে। আরও উল্লম্ব জায়গা প্রয়োজন হলে chevron বাটন ব্যবহার করে এটিকে উপরের ডানদিকে ফ্লোটিং কন্ট্রোল হিসেবে সংকুচিত করুন; এটি পুনরায় সক্রিয় করলে বর্তমান কোয়েরি অক্ষুণ্ণ থাকে।
- পছন্দের তালিকাটি “শুধুমাত্র পছন্দের” ফিল্টার থেকে স্বাধীন। পছন্দগুলি stable setting IDs ব্যবহার করে, Obsidian রিস্টার্টের পরও অক্ষুণ্ণ থাকে, এবং যখন কোনো সেটিংস আর অস্তিত্বে থাকে না তখন পুরানো IDs-গুলি নিরাপদে মুছে ফেলা হয়।

**Diagram preview export PPI** সেটিংসটির ডিফল্ট মান **300 PPI** এবং এটি **72-600** পর্যন্ত মান গ্রহণ করে। এটি শুধুমাত্র PNG রাস্টারাইজেশনকে নিয়ন্ত্রণ করে; SVG এবং PDF vector geometry-কে অক্ষুণ্ণ রাখে। **Also export complete Mermaid visuals** সেটিংসটি ঐচ্ছিক বাহ্যিক Mermaid উপাদানগুলি রপ্তানি করতে সাহায্য করে এবং Drawnix preview-গুলিতে Mermaid-এর দৃশ্যমানতা নিয়ন্ত্রণ করে না।
---
