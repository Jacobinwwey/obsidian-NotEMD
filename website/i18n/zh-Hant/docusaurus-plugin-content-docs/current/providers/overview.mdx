...
id: overview
title: LLM 提供商
description: 設定 36 個 LLM 提供者——雲端、閘道及本地——並為每個任務選擇模型
author:
...
3. **測試連線** — 按下測試按鈕
4. **選用：單任務模型** — 啟用 `useMultiModelSettings` 並分別進行設定
...
- 📝 [概念說明](/docs/features/concept-notes) — 使用任務級別的抽取模型
