...
- Hvert prosjekt beholder sin egen lisens og sine egne vilkår; Notemd er tilgjengelig under [MIT-lisensen](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/LICENSE).
