...
|--------------------|----------|---------|
| **Testar Conexão** | Seções de Configurações --> Provedor | Verifique a chave API e a conectividade |
| **Obter Lista de Modelos** | Seções de Configurações --> Provedor | Confirme quais modelos estão acessíveis |
