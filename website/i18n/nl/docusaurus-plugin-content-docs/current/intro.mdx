...
- Elk project behoudt zijn eigen licentie en voorwaarden; Notemd is beschikbaar onder de [MIT-licentie](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/LICENSE).
