...
- Setiap projek mengekalkan lesen dan syaratnya sendiri; Notemd tersedia di bawah [Lesen MIT](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/LICENSE).
