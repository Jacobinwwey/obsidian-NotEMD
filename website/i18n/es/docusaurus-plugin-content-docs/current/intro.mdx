...
- Cada proyecto conserva su propia licencia y condiciones; Notemd está disponible bajo la [licencia MIT](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/LICENSE).
