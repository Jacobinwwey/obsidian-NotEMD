...
## DISCOVERY OG FAVORITER FOR Notemd INSTILLINGER

Instillings siden er designet til gennemgående brug fremfor enkelt konfiguration:

- Brug feltorienteret indtastningsfelt **Search settings** for at finde en instilling efter dens navn, beskrivelse, alias eller synlig kategori. Resultaterne rangeres efter relevans og fører direkte til den specifikke instilling.
- Brug **★ Favorites** for at gemme instillinger, der justeres ofte, i den aktuelle Vault. Ved at klikke på det åbnes en speciel liste med instillingsnavn, beskrivelse, kategori og en direkte navigeringsadresse. Fjern en favorit fra listen uden at leave instillings siden.
- Discovery-verktøjslinjen er afspændt som standard. Brug chevron-knappen for at folde den til en flydende kontroll i øverst højre hjørne, når du behøver mere vertikal plads; den aktuelle søgning gemmes og genoprettes ved at afspande den igen.
- Favoritlisten er uafhængig fra filteret kun for favoriter. Favoriter bruger stabile instillings-ID:er, overlever restarts af Obsidian, og usikre ID:er fjernes sikrt, når en instilling ikke länger eksisterer.

Instillingen **Diagram preview export PPI** har som standard verdi **300 PPI** og accepterer værdier mellem **72-600**. Den kontrollerer kun rasterisering af PNG; SVG og PDF bevarer vektorgeometrien. Instillingen **Also export complete Mermaid visuals** styrer valgfrie eksterne Mermaid-elementer og har ingen indflydelse på Mermaid-synlighed i Drawnix-forhandsvisninger.
---
