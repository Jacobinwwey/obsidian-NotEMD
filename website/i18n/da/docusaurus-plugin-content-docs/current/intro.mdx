...
- Hvert projekt bevarer sin egen licens og sine egne vilkår; Notemd er tilgængelig under [MIT-licensen](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/LICENSE).
