...
const copyByLocale = {
  en: {
    ...
    facts: [
      ...
      {label: 'Current release', value: 'Version 1.9.6 public docs and release assets'},
    ],
  ...
  'zh-CN': {
    ...
    facts: [
      ...
      {label: '当前版本', value: '1.9.6 公开文档与 release assets'},
    ],
...
export default function Home() {
  ...
  const softwareVersion = siteConfig.customFields?.softwareVersion || '1.9.6';
