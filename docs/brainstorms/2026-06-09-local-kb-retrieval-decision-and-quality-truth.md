...
The [completion measurement](../maintainer/reliability-acceptance-2026-09-12.md#retrieval-quality-and-batch-semantics) now supplies context-token estimates, separated build/query cost and collected retained/released heap. It supports per-batch reuse under the existing lexical architecture; it does not justify a persistent index from this small corpus alone.
