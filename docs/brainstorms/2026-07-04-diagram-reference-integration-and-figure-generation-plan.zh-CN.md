...
- [x] 针对 A/a arc endpoints 增加 arc path endpoint geometry，让曲线电路符号的 path endpoints 参与 bounded-canvas diagnostics。
- [x] 针对 C/S/Q/T curve endpoints 增加 Bezier path endpoint geometry，让 dvisvgm 曲线端点参与 bounded-canvas diagnostics，但不声称 exact curve bounds。
