...
| Verify circuit output before visual repair | Compile-log diagnostics, topology-preserving repair guard, SVG structural smoke, 1/2/4/8-bit indexed-color and RGB PNG foreground smoke, and preview diagnostics are in place | Partially implemented | Add OCR-level label recognition, precise pixel overlap gates, additional PNG grayscale variants, and topology-preserving repair prompts |
