...
- R2. `docs/superpowers/plans/2026-04-14-diagram-rendering-platform-roadmap.md` 必须逐段更新，使每个任务都反映当前实现状态、证据和剩余缺口。
...
- `README.md` 与 `docs/releases/1.8.2.md` 已经记录当前实验性图表功能集，并应继续与代码保持一致。
