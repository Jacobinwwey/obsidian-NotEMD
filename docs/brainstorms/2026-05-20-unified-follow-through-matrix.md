...
5. **P1**: finish provider-settings control-plane convergence with metadata-driven field grouping and lightweight model discovery in an isolated implementation lane
