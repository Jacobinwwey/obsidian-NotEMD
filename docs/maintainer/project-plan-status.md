...
| R5 | P1 | Plugin tests ran only after a release tag; no PR/main workflow existed. | U3 implemented: locked Linux/Windows build/Jest/audits/lint checks; positive/negative remote acceptance is tracked in the execution record. Branch protection is separate. |
