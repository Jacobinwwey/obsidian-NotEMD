...
|---|---|---|---|---|---|
| `mermaid-mindmap` | 概念层级 | Mermaid | `mermaid-mindmap-basics` | 设置页预览动作 | SVG、PNG |
...
| `flowchart` | 控制流程与决策 | Mermaid | `flowchart-release` | 设置页预览动作 | SVG、PNG |
| `sequence` | 有序参与者交互 | Mermaid | `sequence-request` | 设置页预览动作 | SVG、PNG |
| `state` | 生命周期状态与转换 | Mermaid | `state-lifecycle` | 设置页预览动作 | SVG、PNG |
| `class` | 类型所有权与关联 | Mermaid | `class-domain` | 设置页预览动作 | SVG、PNG |
| `entity-relationship` | 实体、字段和基数 | Mermaid | `entity-relationship-schema` | 设置页预览动作 | SVG、PNG |
| `canvas-map` | 空间分组概念 | JSON Canvas | `canvas-map-domains` | iframe / Canvas 产物 | source、SVG、PNG、PDF |
...
|---|---|---|---|---|
| `mermaid` | Mermaid fence source | iframe | SVG、PNG | 无 |
