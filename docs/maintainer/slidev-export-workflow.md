...
7. code splitting is still parser-light. TypeScript/JavaScript now have a top-level tokenizer, but full AST splitting and more language-specific splitters remain future work.
