...
- bounded SVG viewBox, obvious text-overlap, positioned `tspan` label overlap, and label-vs-drawing overlap checks, including transform-aware geometry for common SVG transforms;
