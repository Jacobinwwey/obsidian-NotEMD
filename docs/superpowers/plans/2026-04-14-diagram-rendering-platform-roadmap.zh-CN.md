...
- Drawnix 应作为数据边界 / 转换边界参考，而不是下一步要整体嵌入的宿主；详见 `docs/brainstorms/2026-05-03-drawnix-feasibility-and-integration-direction.zh-CN.md`
...
3. 收紧重型运行时的真实打包边界
4. 完成上述三项后，再恢复 legacy prompt 退役与 MermaidProcessor 缩编
