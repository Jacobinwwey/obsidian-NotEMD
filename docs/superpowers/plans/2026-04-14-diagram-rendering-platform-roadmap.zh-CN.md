...
- helper 还新增了 Stage B 的 packaging 契约真值检查：release 必需资产从 `scripts/release/publish-github-release.js` 同步提取，双语 release notes 文件约束也进入生成清单，同时数字 tag 与 create/upload 模式也成为显式契约检查项。
