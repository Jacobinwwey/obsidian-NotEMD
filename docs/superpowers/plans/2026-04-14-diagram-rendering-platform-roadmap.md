...
### Task 2: 用 Spec-First 生成替代直接 Mermaid Prompt
...
### Task 3: Mermaid Adapter V2 与 `mermaidProcessor.ts` 拆解
...
### Task 4: 具备 Registry、Host、Cache 与 Preview 的渲染平台骨架
...
### Task 5: 将 JSON Canvas 作为首个非 Mermaid 输出
