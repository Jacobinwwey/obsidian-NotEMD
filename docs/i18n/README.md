...
- हिन्दी (Hindi): [README_hi.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_hi.md)
- বাংলা (Bengali): [README_bn.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_bn.md)
- Nederlands (Dutch): [README_nl.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_nl.md)
- Svenska (Swedish): [README_sv.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_sv.md)
- Suomi (Finnish): [README_fi.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_fi.md)
- Dansk (Danish): [README_da.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_da.md)
- Norsk (Norwegian): [README_no.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_no.md)
- Polski (Polish): [README_pl.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_pl.md)
- Türkçe (Turkish): [README_tr.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_tr.md)
- עברית (Hebrew): [README_he.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_he.md)
- ไทย (Thai): [README_th.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_th.md)
- Ελληνικά (Greek): [README_el.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_el.md)
- Čeština (Czech): [README_cs.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_cs.md)
- Magyar (Hungarian): [README_hu.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_hu.md)
- Română (Romanian): [README_ro.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_ro.md)
- Українська (Ukrainian): [README_uk.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_uk.md)
- Tiếng Việt (Vietnamese): [README_vi.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_vi.md)
- Bahasa Indonesia (Indonesian): [README_id.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_id.md)
- Bahasa Melayu (Malay): [README_ms.md](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/README_ms.md)

## In-App UI Locale Coverage

- `auto` follows Obsidian's current UI language.
- The supported in-app UI locale catalog is defined explicitly in [src/i18n/uiLocales.ts](https://github.com/Jacobinwwey/obsidian-NotEMD/blob/main/src/i18n/uiLocales.ts): `en`, `ar`, `de`, `es`, `fa`, `fr`, `id`, `it`, `ja`, `ko`, `nl`, `pl`, `pt`, `pt-BR`, `ru`, `th`, `tr`, `uk`, `vi`, `zh-CN`, `zh-TW`.
